<?php
/**
 * Setup a layout record for a template
 *
 * @package formdatamanager
 * @subpackage processors
 */
 class FormDataManagerTemplateSetupProcessor extends modObjectUpdateProcessor
{
...
return 'FormDataManagerTemplateSetupProcessor';