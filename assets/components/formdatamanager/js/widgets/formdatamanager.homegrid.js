ModFormDataManager.homegrid = function(config) {
	config=config || {};
	Ext.applyIf(config,{
		id:'mod-formdatamanager-homegrid'
	...
	ModFormDataManager.homegrid.superclass.constructor.call(this,config);
};
Ext.extend(ModFormDataManager.homegrid,MODx.grid.Grid,{
	windows:{}
	,getMenu:function() {
		var m = [];
...
Ext.reg('mod-formdatamanager-homegrid',ModFormDataManager.homegrid);